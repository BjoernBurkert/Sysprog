...
int main(void)
{
    ...
    printf("Adresse: %p; Platzbedarf: %lu; Typ: long , Name: LiZahl , Wert: %d\n"
        , (void*) &LiZahl, (unsigned long) sizeof LiZahl, LiZahl);
    printf("Adresse: %p; Platzbedarf: %lu; Typ: unsigned int , Name: UiBytefolge , Wert: %d\n"
        , (void*) &UiBytefolge, (unsigned long) sizeof UiBytefolge, UiBytefolge);
    printf("Adresse: %p; Platzbedarf: %lu; Typ: unsigned short int , Name: USiBytefolge , Wert: %d\n"
        , (void*) &USiBytefolge, (unsigned long) sizeof USiBytefolge, USiBytefolge);
    printf("Adresse: %p; Platzbedarf: %lu; Typ: unsigned long int , Name: ULiBytefolge , Wert: %d\n"
        , (void*) &ULiBytefolge, (unsigned long) sizeof ULiBytefolge, ULiBytefolge);
    printf("Adresse: %p; Platzbedarf: %lu; Typ: float , Name: fiZahl , Wert: %d\n"
        , (void*) &fZahl, (unsigned long) sizeof fZahl, fZahl);
    printf("Adresse: %p; Platzbedarf: %lu; Typ: double , Name: dZahl , Wert: %d\n"
        , (void*) &dZahl, (unsigned long) sizeof dZahl, dZahl);
    printf("Adresse: %p; Platzbedarf: %lu; Typ: long double , Name: ldZahl , Wert: %d\n"
        , (void*) &ldZahl, (unsigned long) sizeof ldZahl, ldZahl);
    printf("Adresse: %p; Platzbedarf: %lu; Typ: char , Name: zeichen , Wert: %d\n"
    ...
    printf("Adresse: %p; Platzbedarf: %lu; Typ: unsigned cahr , Name: ucByte , Wert: %d\n"
        , (void*) &ucByte, (unsigned long) sizeof ucByte, ucByte);
    printf("Adresse: %p; Platzbedarf: %lu; Typ: String , Name: s , Wert: %d\n"
